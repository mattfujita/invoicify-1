...
public class InvoiceController {
	...
	@PostMapping("create")
	public ModelAndView createInvoice(Invoice invoice, long clientId, long[] recordIds, Authentication authentication) {
		...
		} catch (InvalidDataAccessApiUsageException error) {
